...
for i = 1:length(data_log_file)
    ...
    col_rs_UM = find(cellfun (@(x) strcmp('Responsive_Stims_Excited',x), dlUM_raw{i}(1,:)));
...
switch ana_type
    ...
    text('Units','normalized','Position',[0.84,0.93,0],'HorizontalAlignment','left','String','RS','Color',RSColor,'FontSize',figparams.fsize,'FontName',figparams.fontchoice,'FontWeight','bold');
    text('Units','normalized','Position',[0.84,0.84,0],'HorizontalAlignment','left','String','FS','Color',FSColor,'FontSize',figparams.fsize,'FontName',figparams.fontchoice,'FontWeight','bold');
    ...
    case 'Vocalization responses'
        ...
        axf8p1 = axes(fig8,'Position',[lmargin tmargin-ywidth 0.32 ywidth]);
        CImax_RS = CImax_plusprestim(strcmp(groupIDcrit_plusprestim,'RS'));
        hb1 = bar(1, mean(CImax_RS,'omitnan'));
        ...
        hb2 = bar(2, mean(CImax_FS,'omitnan'));
        ...
        CImax_Bu1 = CImax_plusprestim(strcmp(groupIDcrit_plusprestim,'Burster_h'));
        hb3 = bar(3, mean(CImax_Bu1,'omitnan'));
        ...
        CImax_Bu2 = CImax_plusprestim(strcmp(groupIDcrit_plusprestim,'Burster_l'));
        hb4 = bar(4, mean(CImax_Bu2,'omitnan'));
        ...
        hb5 = bar(5, mean(CImax_PBu,'omitnan'));
        ...
        hb7 = bar(7, mean(CImax_RS_GMM,'omitnan'));
        set(hb7,'FaceColor',RSColor,'FaceAlpha',0.5,'EdgeColor','none');
        hold on
        errorbar (7, mean(CImax_RS_GMM,'omitnan'),std(CImax_RS_GMM,'omitnan')/sqrt(length(find(~isnan(CImax_RS_GMM)))),'Color',[0.45 0.45 0.45],'LineWidth',0.8,'CapSize',3);

        CImax_FS_GMM = CImax(strcmp(groupIDgmm_plusprestim,'FS'));
        hb8 = bar(8, mean(CImax_FS_GMM,'omitnan'));
        set(hb8,'FaceColor',FSColor,'FaceAlpha',0.5,'EdgeColor','none');
        errorbar (8, mean(CImax_FS_GMM,'omitnan'),std(CImax_FS_GMM,'omitnan')/sqrt(length(find(~isnan(CImax_FS_GMM)))),'Color',[0.45 0.45 0.45],'LineWidth',0.8,'CapSize',3);

        CImax_Bu_GMM = CImax(strcmp(groupIDgmm_plusprestim,'Burster'));
        hb9 = bar(9, mean(CImax_Bu_GMM,'omitnan'));
        set(hb9,'FaceColor',BuColor,'FaceAlpha',0.5,'EdgeColor','none');
        errorbar (9, mean(CImax_Bu_GMM,'omitnan'),std(CImax_Bu_GMM,'omitnan')/sqrt(length(find(~isnan(CImax_Bu_GMM)))),'Color',[0.45 0.45 0.45],'LineWidth',0.8,'CapSize',3);

        p4 = 0.001;
        p5 = 0.001;
        p6 = 0.001;

        sigstar({[7 9],[7 8],[8 9]},[p4 p5 p6]);
        ...
        text(2,2,num2str(length(find(~isnan(CImax_FS)))),'FontSize',figparams.fsize-1,'HorizontalAlignment','center','Color',[0.2 0.2 0.2]);
        text(3,2,num2str(length(find(~isnan(CImax_Bu1)))),'FontSize',figparams.fsize-1,'HorizontalAlignment','center','Color',[0.2 0.2 0.2]);
        text(4,2,num2str(length(find(~isnan(CImax_Bu2)))),'FontSize',figparams.fsize-1,'HorizontalAlignment','center','Color',[0.2 0.2 0.2]);
        text(5,2,num2str(length(find(~isnan(CImax_PBu)))),'FontSize',figparams.fsize-1,'HorizontalAlignment','center','Color',[0.2 0.2 0.2]);

        text(7,2,num2str(length(find(~isnan(CImax_RS_GMM)))),'FontSize',figparams.fsize-1,'HorizontalAlignment','center','Color',[0.2 0.2 0.2]);   
        text(8,2,num2str(length(find(~isnan(CImax_FS_GMM)))),'FontSize',figparams.fsize-1,'HorizontalAlignment','center','Color',[0.2 0.2 0.2]);
        text(9,2,num2str(length(find(~isnan(CImax_Bu_GMM)))),'FontSize',figparams.fsize-1,'HorizontalAlignment','center','Color',[0.2 0.2 0.2]);

        axf8p2 = axes(fig8,'Position',[lmargin+0.37+2*intercol tmargin-ywidth 0.35 ywidth]);
        ...
        [q_opt_334, perc_correct_opt, pc_334, z_334, H_334] =  sim_classify2 (spk_ms, D, stim_len, pre_stim, post_stim,  1:20, 1:10,params.q,1:20,params.nsims,0,params.nhsims)
        ...
        [q_opt_1425, perc_correct_opt, pc_1425, z_1425, H_1425] =  sim_classify2 (spk_ms, D, stim_len, pre_stim, post_stim,  1:20, 1:10,params.q,1:20,params.nsims,0,params.nhsims)
        ...
        [q_opt_760, perc_correct_opt, pc_760, z_760, H_760] =  sim_classify2 (spk_ms, D, stim_len, pre_stim, post_stim,  1:20, 1:10,params.q,1:20,params.nsims,0,params.nhsims)
        ...
        [q_opt_646, perc_correct_opt, pc_646, z_646, H_646] =  sim_classify2 (spk_ms, D, stim_len, pre_stim, post_stim,  1:20, 1:10,params.q,1:20,params.nsims,0,params.nhsims)
        ...
        axes(axf8p1);
        tif8p1 = text(-0.22,1.072,'A','Units','normalized',fontstr_l{:}); 
        axes(axvp1(1));
        text(tif8p1.Position(1)*axf8p1.Position(3)/axvp1(1).Position(3),1.072,'C','Units','normalized',fontstr_l{:});  
        axes(axvp2);
        text(tif8p1.Position(1)*axf8p1.Position(3)/axvp2.Position(3),1.15,'D','Units','normalized',fontstr_l{:}); 
        axes(axvp3);
        text(tif8p1.Position(1)*axf8p1.Position(3)/axvp3.Position(3)*0.7,1.15,'E','Units','normalized',fontstr_l{:});
        axes(axvp4);
        text(tif8p1.Position(1)*axf8p1.Position(3)/axvp4.Position(3)*0.7,1.15,'F','Units','normalized',fontstr_l{:}); 
