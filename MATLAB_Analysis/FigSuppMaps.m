...
% Set up panels
ax_sch = axes(gcf,'Position',[lmargin, 1-tmargin-0.23, 0.4, 0.19]); 
th_A = annotation('textbox',[ax_sch.Position(1)+letteroffset(1), ...
    ax_sch.Position(2)+ax_sch.Position(4)+letteroffset(2), 0, 0],...
    'EdgeColor','none',...
    'String','A',...
...
ax_viol(1) = axes(gcf,'Position',[lmargin+ax_sch.Position(3)+intercol,...
